export const endpoints = {
  auth: { login: '/auth/login', registerSeller: '/auth/register-seller', refresh: '/auth/refresh', logout: '/auth/logout', verifyOtp: '/auth/verify-otp', resendOtp: '/auth/resend-otp', forgotPassword: '/auth/forgot-password', resetPassword: '/auth/reset-password' },
