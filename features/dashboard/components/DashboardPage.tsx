...
export function DashboardPage({ setView }: { setView: (view: View) => void }) {
  return <>
    ...
    <div className="metrics-grid">
      ...
      <MetricCard label="Settlement readiness" value="Review status" change="Transfers not configured" icon={ReceiptIndianRupee} accent="purple" />
    </div>
